...
class StandardBottomSheetPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _StandardBottomSheetPageState();
}

class _StandardBottomSheetPageState extends State<StandardBottomSheetPage> {
  ...
  Widget build(BuildContext context) {
    return Center(
        child: RaisedButton(
            ...
            child: const Text('Bottom Sheets Up!')));
  }
}
